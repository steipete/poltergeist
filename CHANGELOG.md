...
- Hardened panel crash diagnostics with private per-user storage and preserved hardware-cursor and clear-on-shrink settings while upgrading pi-tui to 0.85.1. Thanks @dependabot.
